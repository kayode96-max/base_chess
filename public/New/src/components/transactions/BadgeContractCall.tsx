...
export function BadgeContractCall({ onSuccess, onError }: BadgeContractCallProps) {
  ...
  const buildTransactionRequest = (): TransactionRequest => {
    ...
    switch (functionName) {
      case 'mint-badge':
        return {
          ...baseRequest,
          functionArgs: [badgeId, recipient],
        };
      case 'revoke-badge':
        return {
          ...baseRequest,
          functionArgs: [badgeId],
        };
      case 'transfer-badge':
        return {
          ...baseRequest,
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h3 className="text-lg font-semibold mb-4">Badge Contract Call</h3>
      ...
      <div className="space-y-4">
        <div>
          ...
          >
            <option value="mint-badge">Mint Badge</option>
            <option value="revoke-badge">Revoke Badge</option>
            <option value="transfer-badge">Transfer Badge</option>
          </select>
        </div>
